...
<br>
<img src="https://zhiftydk.github.io/ForgottenGames/images/pixeline-i-pixieland.png" width="300rem"/>
...
<script>
    const id = "pixeline-cd-12-i-pixieland";
    async function load() {
...
The game doesnt scale properly (postage stamp effect) on displays with a resolution over 1920x1080. The game is only tested with these fixes on a 64bit Windows machine.
